  ...
  return (
    <>
      ...
      >
        <a
          href="#"
          className="h-full w-[160px] min-w-[130px] rounded-sm border-2 border-transparent p-1 duration-200 hover:border-white"
        >
          <img src="navigationImgs/amazon-logo-white.png" className="p-2" />
        </a>

        <div className="flex h-full min-w-[185px] cursor-pointer flex-row-reverse items-center justify-center gap-1 rounded-sm border-2 border-transparent p-2 duration-200 hover:border-white">
        ...
        <div className="flex h-full min-w-[83px] cursor-pointer items-center justify-center gap-1 rounded-sm border-2 border-transparent p-2 duration-200 hover:border-white">
          <div>
            <p className="text-sm leading-3 text-white">Returns</p>
            <p className="text-md font-black leading-4 text-white">& Orders</p>
          </div>
        </div>
        <div className="relative flex h-full cursor-pointer justify-center gap-1 rounded-sm border-2 border-transparent p-2 duration-200 hover:border-white">
