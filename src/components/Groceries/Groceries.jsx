          ...
          <div className="absolute left-1 top-9 flex flex-col gap-2 rounded-sm bg-white p-5 shadow-lg">
            <div className="flex flex-col">
              <div className="flex h-16 w-[335px] items-center justify-start gap-5 overflow-hidden rounded-md bg-neutral-100">
                ...
                />
                <div className="group">
                  <p className="text-lg font-bold text-black decoration-red-500 group-hover:underline">
                    Find a nearby store
                  </p>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="flex h-40 w-40 flex-col items-center justify-center gap-2 rounded-md bg-neutral-100 duration-200 hover:bg-neutral-200">
                <img src="public/fresh.png" alt="fresh" className="w-32" />
              </div>
